...
import nl.hauntedmc.velocityhotreloaded.common.entities.results.CloseablePluginResult;
...
import nl.hauntedmc.velocityhotreloaded.common.providers.PluginProvider;
import nl.hauntedmc.velocityhotreloaded.common.utils.DependencyUtils;

public abstract class AbstractPluginManager<P, D extends VHRPluginDescription> implements PluginProvider<P, D> {
