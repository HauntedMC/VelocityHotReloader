package nl.hauntedmc.velocityhotreloaded.velocity.commands;
...
import nl.hauntedmc.velocityhotreloaded.common.commands.CommandVHR;
...
public class VelocityCommandVHR extends CommandVHR<VelocityPlugin, PluginContainer, VelocityAudience> {

    public VelocityCommandVHR(VelocityPlugin plugin) {
